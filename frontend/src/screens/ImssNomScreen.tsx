...
const ImssNomScreen = () => {
    ...
    const renderNomHome = () => (
        <View style={styles.sectionContainer}>
            ...
            <TouchableOpacity style={styles.mainActionButton} onPress={() => setNomView('test_intro')}>
    ...
    const renderTestIntro = () => (
        <View style={styles.sectionContainer}>
            ...
            <TouchableOpacity style={styles.secondaryButton} onPress={() => setNomView('home')}>
    ...
    const renderTestQuestions = () => {
        ...
        return (
            <View style={styles.sectionContainer}>
                ...
                <TouchableOpacity style={{ marginTop: 20, alignSelf: 'center' }} onPress={() => setNomView('home')}>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.tabContainer}>
                <TouchableOpacity
                    ...
                    onPress={() => { setActiveTab('nom035'); setNomView('home'); }}
                >
